...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<CustomErrorDTO> entityErrorException(ResourceNotFoundException e, HttpServletRequest req) {
    ...
    public ResponseEntity<CustomErrorDTO> databaseErrorException(DatabaseException e, HttpServletRequest req) {
